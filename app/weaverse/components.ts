...
import * as ButtonCustom from "~/components/button-custom";
...
import * as Highlights from "~/sections/highlight/index";
import * as HightlightItem from "~/sections/highlight/item";
