    ...
    },
    {
      ...
      inputs: [
        ...
        },
        {
          ...
          defaultValue: 150,
          condition: "enableFreeShippingProgressBar.eq.true",
        },
        {
          type: "text",
          label: "Progress message",
          name: "freeShippingProgressMessage",
          defaultValue: "{{amount}} away from free shipping!",
          placeholder: "{{amount}} away from free shipping!",
        ...
        },
        {
          ...
          condition: "enableCartNote.eq.true",
        },
        {
          type: "switch",
        ...
        },
        {
          ...
          condition: "enableDiscountCode.eq.true",
        },
        {
          type: "switch",
