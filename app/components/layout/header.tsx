...
export function Header() {
	...
	return (
		<>
			...
			>
				<div className="hidden w-full items-center justify-center bg-[#F0EDED] px-6 py-3 text-[#3B2028] md:flex lg:py-4 [&_.main-logo]:!opacity-100 [&_.transparent-logo]:!opacity-0">
					<div className="mx-auto flex w-full max-w-lg items-center justify-between px-6">
						<div className="flex w-77.75 shrink-0 items-center gap-5 text-[13px] font-medium leading-normal text-[#6B5A56]">
