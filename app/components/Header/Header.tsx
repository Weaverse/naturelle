...
type HeaderProps = Pick<LayoutProps, 'header' | 'cart' | 'isLoggedIn' | 'env'>;

type Viewport = 'desktop' | 'mobile';

export function Header({header, isLoggedIn, cart, env}: HeaderProps) {
  const {shop, menu} = header;
  const headerMenu = menu
    ? parseMenu(menu, shop.primaryDomain.url, env)
    : undefined;
